package FCC::Action::Admin::PrfaddsetAction;
$VERSION = 1.00;
use strict;
use warnings;
...
sub dispatch {
    ...
    my $in_names = [
        ...
        'prof_intro',              'prof_intro2',                'prof_memo',                    'prof_memo2',              'prof_logo_up',               'prof_logo_del',
        'prof_status',             'prof_app1',                  'prof_app2',                    'prof_app3',               'prof_app4',                  'prof_override_margin',
